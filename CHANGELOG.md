...
### Fixed
- replace dead Odesli API with song.link page scraping

### Changed
- test: fix integration test mocks for song.link HTML scraping

## [0.2.25] — 2026-06-10

### Added
- replace Spotify API with embed scraping for playlist import

### Fixed
- XSS in OG injection, preview recovery, atomic track limit; add D1 indexes

### Changed
- docs: remove Spotify API credentials from setup, update search description
